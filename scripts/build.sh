...
go build -ldflags "-X github.com/haowang0402/coreth/plugin/evm.GitCommit=$coreth_commit -X github.com/haowang0402/coreth/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
